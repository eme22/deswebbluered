...
<head>
    ...
    <title>BlueRed - Panel de Trabajador</title>
...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="VistaGeneral.jsp" target="iframe1"><i class="fas fa-question"></i> Vista General</a>
            </li>
            <li>
                <a href="TrabajadoresServlet" target="iframe1"><i class="fas fa-briefcase"></i> Trabajadores</a>
            </li>
            <li>
                <a href="VistaGeneral.jsp" target="iframe1"><i class="fas fa-users"></i></i> Clientes</a>
            </li>
            <li>
                <a href="VistaGeneral.jsp" target="iframe1"><i class="fas fa-route"></i> Viajes</a>
            </li>
            <li>
                <a href="VistaGeneral.jsp" target="iframe1"><i class="fas fa-location-arrow"></i></i> Sitios</a>
            </li>
            <li>
                <a href="VistaGeneral.jsp" target="iframe1"><i class="far fa-clock"></i> Reservas</a>
            </li>
            <li>
                <a href="VistaGeneral.jsp" target="iframe1"><i class="fas fa-bus"></i> Buses</a>
            </li>
        </ul>
    </div>
    <!-- /#sidebar-wrapper -->
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <iframe frameborder="no" style="width: 100%; height: 100%;" name="iframe1" src="VistaGeneral.jsp" onload="window.top.scrollTo(0,0);">
            </iframe>
        </div>
    </div>
